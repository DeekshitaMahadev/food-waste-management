...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        // Check credentials
        $stmt = $conn->prepare("SELECT id, name, email, password FROM donors WHERE email = ?");
        ...
        if ($result->num_rows == 1) {
            ...
            if (password_verify($password, $donor['password'])) {
                // Login successful
                login_donor($donor['id'], $donor['email'], $donor['name']);
                header("Location: donor_dashboard.php");
                exit();
            } else {
...
<head>
    ...
    <title>Donor Login - Smart Food Donation System</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="donor_register.php">Register</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="donor_login.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Donor Login</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    <div class="card-header bg-green text-white text-center">
                        <h3><i class="fas fa-sign-in-alt me-2"></i>Donor Login</h3>
                    </div>
                    <div class="card-body">
